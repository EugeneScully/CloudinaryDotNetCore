...
namespace CloudinaryDotNet
{
    ...
    public partial class Cloudinary
    {
        ...
        /// </summary>
        public Cloudinary(IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
            m_api = new Api(contextAccessor);
        }
        ...
        public Cloudinary(string cloudinaryUrl, IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
            m_api = new Api(cloudinaryUrl, contextAccessor);
        }
        ...
        public Cloudinary(Account account, IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
            m_api = new Api(account, contextAccessor);
        }
        ...
        public ListUploadPresetsResult ListUploadPresets(ListUploadPresetsParams parameters)
        {
            UrlBuilder urlBuilder = new UrlBuilder(
                ...
                .Add("upload_presets")
                .BuildUrl(),
                parameters.ToParamsDictionary(), _contextAccessor);
        ...
        public DelResResult DeleteResources(DelResParams parameters)
        {
            ...
            UrlBuilder urlBuilder = new UrlBuilder(url.BuildUrl(), parameters.ToParamsDictionary(), _contextAccessor);
        ...
        private string GetUploadMappingUrl(UploadMappingParams parameters)
        {
            ...
            return new UrlBuilder(uri, parameters.ToParamsDictionary(), _contextAccessor).ToString();
        }
